...
public class GroupAClusteringConsumerA implements RocketMQListener<MessageExt>, RocketMQPushConsumerLifecycleListener {

    @Override
    public void onMessage(MessageExt message) {
        System.out.println("我是groupA中的第一个消费者:" + new String(message.getBody()));
    }

    @Override
    public void prepareStart(DefaultMQPushConsumer consumer) {
        //设置当前实例的唯一名称,否则同组内多个消费者会报错
        consumer.setInstanceName("GroupAClusteringConsumerA");
    }
}
