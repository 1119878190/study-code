...
public class GroupAClusteringConsumerC implements RocketMQListener<MessageExt>, RocketMQPushConsumerLifecycleListener {

    @Override
    public void onMessage(MessageExt message) {
        System.out.println("我是groupA中的第三个消费者:" + new String(message.getBody()));
    }

    @Override
    public void prepareStart(DefaultMQPushConsumer consumer) {
        //设置当前实例的唯一名称,否则同组内多个消费者会报错
        consumer.setInstanceName("GroupAClusteringConsumerC");
    }
}
